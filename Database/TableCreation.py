...
def table_creation():
    ...
    with my_sql_connection() as c:
        ...
        c.execute(
            f"CREATE TABLE {config.db_name}.users ("
        ...
        c.execute(
            f"CREATE TABLE {config.db_name}.contacts ("
            "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
        ...
        c.execute(
            f"CREATE TABLE {config.db_name}.interactions ("
            "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
        ...
        c.execute(
            f"CREATE TABLE {config.db_name}.reminders ("
            "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,"
            "contact_id INT NOT NULL REFERENCES contacts(id),"
            "interaction_id INT DEFAULT NULL REFERENCES interactions(id),"
